...
class TestBase_instantiation(unittest.TestCase):
    """unittest class for base __init__"""
    ...
    def test_nb_objects_after_user_id(self):
        b1 = Base()
        b2 = Base(20)
        b3 = Base()
    ...
    def test_nb_objects_private(self):
        with self.assertRaises(AttributeError):
            print(Base(20).__nb_objects)

    def test_str_id(self):
        self.assertEqual('me', Base('me').id)

    def test_float_id(self):
        self.assertEqual(9.5, Base(9.5).id)
    ...
    def test_bytearray_id(self):
        self.assertEqual(bytearray(b'abc'), Base(bytearray(b'abce')).id)
...
class TestBase_to_json_string(unittest.TestCase):
    """unittest class for base to_json_string"""
...
class TestBase_save_to_file(unittest.TestCase):
    """unittest class for base save_to_file"""
    @classmethod
    def tearDown(self):
...
class TestBase_from_json_string(unittest.TestCase):
    """unittest class for base from_json_string"""
...
class TestBase_create(unittest.TestCase):
    """unittest class for base create"""
...
class TestBase_load_from_file(unittest.TestCase):
    """unittest class for base load_from_file"""
    @classmethod
    def tearDown(self):
        """Delete any created files."""
        try:
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """unittest class for base save_to_file_csv"""
    @classmethod
    def tearDown(self):
        """Delete any created files."""
        try:
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """unittest class for base load_from_file_csv"""
    @classmethod
    def tearDown(self):
        """Delete any created files."""
        try:
